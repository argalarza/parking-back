...
class AdminLoginUseCase:
    ...
    def execute(self, username: str, password: str) -> dict:
        ...
        return {
            "access_token": self._create_access_token(subject_id=admin["id"], subject_type="admin"),
            "token_type": "bearer",
        }
...
class ChangePasswordUseCase:
    ...
    def execute(self, person_id: UUID, current_password: str, new_password: str) -> dict:
        password_hash = self._repository.get_person_password_hash_by_id(person_id)
        ...
        self._repository.update_person_password(person_id=person_id, password_hash=new_password_hash)
        return {
            "success": True,
